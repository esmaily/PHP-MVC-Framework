...
class FoundException extends \Exception
{
	...
	private function templateException ($title = NULL, $exception = NULL)
	{
		...
		$message   .= "<p style='font-size: 18px;color: #333;'><span style='text-transform: capitalize;font-weight: bolder'>File : </span>{$this->_exceptions['file']}</p>";
		$message   .= "<p style='font-size: 18px;color: #333;'><span style='text-transform: capitalize;font-weight: bolder'>In Line : </span>{$this->_exceptions['line']}</p>";
		$message   .= "<p style='text-transform: capitalize;font-size: 18px;color: #333;'>{$exception}</p>";
		$message   .= "</div>";
